  ...
  return (
    <main className="min-h-screen bg-[#f6f1e8] text-slate-950">
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-5 py-8 sm:px-8 lg:px-10">
        <nav className="flex flex-col gap-3 rounded-[2rem] border border-white/70 bg-white/75 px-5 py-4 shadow-sm backdrop-blur sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <Link href="/#demo" className="rounded-full bg-slate-950 px-4 py-2 text-center text-sm font-black text-white shadow-lg shadow-slate-950/20">
            내 방도 다시 만들기
          </Link>
        </nav>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
          ...
          <div className="rounded-[2.5rem] bg-slate-950 p-5 text-white shadow-2xl shadow-slate-950/20">
            <div className={`relative flex min-h-80 flex-col justify-between overflow-hidden rounded-[2rem] ${heroConcept.palette} p-5 text-slate-950`}>
              ...
              <div className="relative z-10 flex items-start justify-between gap-4">
                <div className="rounded-3xl bg-white/85 p-4 shadow-sm backdrop-blur">
                  <p className="text-xs font-black text-amber-700">AI After Preview</p>
        ...
        <section className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="rounded-[2rem] bg-white p-5 shadow-xl shadow-amber-900/5 ring-1 ring-black/5 sm:p-6">
            <p className="text-sm font-black text-amber-700">시안 비교</p>
          ...
          <div className="rounded-[2rem] bg-slate-950 p-5 text-white shadow-xl shadow-slate-950/15 sm:p-6">
            <p className="text-sm font-black text-amber-300">쇼핑 리스트</p>
